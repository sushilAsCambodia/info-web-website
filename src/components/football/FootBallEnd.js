              ...
              {Last7Days().map((item, index) => {
                ...
                return (
                  <Grid
                    ...
                    item
                    className={`${
                      item.DateMonth === dateFilter ? "dateSelected" : ""
                    }`}
                    onClick={() => {
              ...
              >
                ...
                <TableBody>
                  {footballEndList && footballEndList.length > 0 ? (
                    footballEndList.map((item, index) => {
