...
export default function ConfirmationModalWeb(props) {
  const { _handleLogout, open, setOpen, message } = props;
  ...
  return (
    ...
    >
      <Fade in={open}>
        {!loading ? (
          <Grid sx={style} container style={{ justifyContent: "center" }}  className="loggggoog" >
            <Grid
              container
              item
              xs={12}
