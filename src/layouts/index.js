...
className="calendraDrawer"
      ...
      <TabPanel value={value} index={0} padding="0px !important" textAlign="center !important">
       <List sx={{padding:"0px !important", margin:"0px !important", display:"flex", justifyContent:"center", textAlign:"center !important"}}>
        <ListItem style={{padding:"3px 3px", margin:"0px 3px", background:"#FF6F31",color:"#fff", borderRadius:"20px", textAlign:"center !important"}}>
            <Typography fontSize="12px">Issue 01</Typography>
        </ListItem>
        <ListItem style={{padding:"3px 3px", margin:"0px 3px", background:"#FF6F31",color:"#fff", borderRadius:"20px", textAlign:"center !important"}}>
            <Typography fontSize="12px">Issue 01</Typography>
        </ListItem>
